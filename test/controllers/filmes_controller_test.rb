...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference("Filme.count") do
      post filmes_url, params: { filme: { ano: @filme.ano, diretor: @filme.diretor, duracao: @filme.duracao, sinopse: @filme.sinopse, titulo: @filme.titulo, user_id: @filme.user_id } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { ano: @filme.ano, diretor: @filme.diretor, duracao: @filme.duracao, sinopse: @filme.sinopse, titulo: @filme.titulo, user_id: @filme.user_id } }
